...
class inpainter(nn.Module):
    ...
    def warm_start(self):
    '''
     TODO: need to implement the warm start stuff described in section 4.2 for batchnorm:: decoder batchnnorm live 
          for a bit at 2e-4 then both encode and decode batchnorm go live at 5e-5
    '''
        pass
